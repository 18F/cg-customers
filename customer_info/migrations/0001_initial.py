# -*- coding: utf-8 -*-
# Generated by Django 1.11.1 on 2017-06-12 21:07
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('agreement_close_date', models.DateField(blank=True, null=True, verbose_name='Agreement Close Date')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('agreement', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='customer_info.Agreement')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('billing', models.CharField(choices=[('active funding agreement', 'This is an org with an active funding agreement'), ('tts internal & no funding', 'This is an org serving TTS internal purposes with no funding agreement'), ('cloud.gov internal & no funding', 'This is an org for cloud.gov internal purposes, so it does not have a funding agreement'), ('misc. unbilled', 'This is unbilled for some other reason approved by the BU and documented in comments below')], default='active funding agreement', max_length=32, verbose_name='Billing')),
                ('agreement', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='customer_info.Agreement', verbose_name='Agreement')),
            ],
        ),
        migrations.CreateModel(
            name='OrgComment',
            fields=[
                ...
                ('note', models.TextField()),
                ('created_on', models.DateTimeField(auto_now_add=True)),
                ('org', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='customer_info.Org')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('monthly_price', djmoney.models.fields.MoneyField(decimal_places=2, default=Decimal('0.0'), default_currency='USD', max_digits=12)),
            ],
        ),
        migrations.CreateModel(
            name='PackageHistory',
            fields=[
                ...
                ('org', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='customer_info.Org')),
                ('package_type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='customer_info.Package')),
            ],
        ),
        migrations.CreateModel(
            name='QuotaHistory',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=128, verbose_name='Quota Name')),
